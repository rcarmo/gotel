...
replace (
	cloud.google.com/go/compute/metadata => cloud.google.com/go v0.65.0
	go.opentelemetry.io/collector/semconv => go.opentelemetry.io/collector/semconv v0.91.0
)
